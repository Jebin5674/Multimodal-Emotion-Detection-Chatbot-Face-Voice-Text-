...
| **Backend** | Python / TensorFlow | Deep Learning framework support |

---

## 📐 System Architecture
1.  **Capture:** The system takes a webcam snapshot, an audio recording, and a text prompt from the user.
2.  **Analysis:**
    *   **Face Module:** Processes the image for visual emotions.
    *   **Voice Module:** Transcribes audio to text via Whisper.
    *   **Text Module:** Evaluates the sentiment of both transcribed and typed text.
3.  **Context Fusion:** The emotional data is combined to create a "contextual prompt."
4.  **Response:** DialoGPT processes the context and generates a human-like, empathetic reply.
...
code
Bash
git clone https://github.com/Jebin5674/Multimodal-Emotion-Detection-Chatbot-Face-Voice-Text-.git
cd Multimodal-Emotion-Detection-Chatbot-Face-Voice-Text-
